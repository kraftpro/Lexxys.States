...
namespace State.Statecharts
{
	class StatechartBuilderTest
	{
		public static void Go()
		{
			...
			var chart2 = new StatechartBuilder2();
			chart2
				.Begin<Expense, ExpenseSupper, ExpenseActions>("expenses")
					.OnEnter((e, s) => e.SetSupper(s))
					.OnExit((e, s) => e.ExitStep())
					.State(ExpenseSupper.Submitted)
						.Begin<Expense, ExpenseStep, ExpenseActions>()
			...
			var expenseChart0 = new StatechartBuilder<Expense, ExpenseStep, ExpenseActions>()
			...
			var expenseChar = new StatechartBuilder<Expense, ExpenseStep>()
			...
			var expenseCh = new StatechartBuilder<Expense, Enum>()
